...
public class QShopReview extends EntityPathBase<ShopReview> {
    ...
    private static final long serialVersionUID = 1692625679L;
    ...
    public final in.koreatech.koin.domain.user.model.QStudent reviewer;
    ...
    public QShopReview(Class<? extends ShopReview> type, PathMetadata metadata, PathInits inits) {
        ...
        this.reviewer = inits.isInitialized("reviewer") ? new in.koreatech.koin.domain.user.model.QStudent(forProperty("reviewer"), inits.get("reviewer")) : null;
