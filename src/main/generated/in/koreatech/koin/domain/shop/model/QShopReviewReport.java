...
public class QShopReviewReport extends EntityPathBase<ShopReviewReport> {
    ...
    private static final long serialVersionUID = -728373981L;
    ...
    public final in.koreatech.koin.domain.user.model.QStudent userId;
    ...
    public QShopReviewReport(Class<? extends ShopReviewReport> type, PathMetadata metadata, PathInits inits) {
        ...
        this.userId = inits.isInitialized("userId") ? new in.koreatech.koin.domain.user.model.QStudent(forProperty("userId"), inits.get("userId")) : null;
    }
