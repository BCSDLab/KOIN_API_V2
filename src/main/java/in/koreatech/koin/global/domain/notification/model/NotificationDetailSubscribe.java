...
@Entity
@Getter
@Table(name = "notification_detail_subscribe")
@NoArgsConstructor(access = PROTECTED)
public class NotificationDetailSubscribe extends BaseEntity {
    ...
    private NotificationSubscribeType notificationSubscribeType;
