...
import in.koreatech.koin.domain.bus.batch.response.CityBusRouteApiResponse;
...
public class CityBusRouteClient {
    ...
    public List<CityBusRoute> fetchBusRouteList(String nodeId) {
        try {
            ...
            return Optional.ofNullable(response.getBody())
                .map(CityBusRouteApiResponse::extractBusRouteInfo)
