...
public class ArticleSummaryPromptBuilder {
    ...
    public ArticleSummaryPrompt build(ArticleSummarySource source) {
        ...
        String userMessage = """
            ...
            text에는 이모지를 넣지 말고, 가능하면 80~180자, 최대 260자 이내의 자연스러운 한국어 문장으로 작성하세요.
            ...
            서로 독립적인 핵심은 별도 항목으로 분리하되, 최대 항목 수를 넘기지 마세요.
    ...
    public ArticleSummaryPrompt buildValidationCorrection(
        ...
        String userMessage = """
            ...
            2. 각 text는 가능하면 80~180자, 최대 260자 이내의 자연스러운 문장으로 줄이되, 마감일/시간/대상/제출처/제출서류/금액/혜택/유의사항 같은 핵심 세부값은 우선 보존하세요.
