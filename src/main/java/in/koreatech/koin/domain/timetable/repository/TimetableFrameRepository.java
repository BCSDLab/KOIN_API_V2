...
public interface TimetableFrameRepository extends Repository<TimetableFrame, Integer> {
    ...
    Optional<TimetableFrame> findByUserIdAndSemester(Integer userId, String semester);
    ...
    default TimetableFrame getByUserIdAndSemester(Integer userId, String semester) {
        return findByUserIdAndSemester(userId, semester)
