...
public class TimetableFrameNotFoundException extends DataNotFoundException {
    ...
    public TimetableFrameNotFoundException(String message) { super(message); }

    public TimetableFrameNotFoundException(String message, String detail) { super(message, detail);}
