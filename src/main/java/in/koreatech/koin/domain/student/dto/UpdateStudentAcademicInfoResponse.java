...
public record UpdateStudentAcademicInfoResponse(
    ...
    public static UpdateStudentAcademicInfoResponse from(Student student) {
        return new UpdateStudentAcademicInfoResponse(
