...
public interface CoopShopApi {
    ...
    @Operation(summary = "특정 생협 매장 정보 id로 조회")
    ...
    @Operation(summary = "특정 생협 매장 정보 이름으로 조회")
    @GetMapping("/type/{coopShopType}")
    ResponseEntity<CoopShopResponse> getCoopShopByType(
        @Parameter(in = PATH) @PathVariable("coopShopType") CoopShopType type
    );
}
