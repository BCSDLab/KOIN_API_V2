...
public enum OrderableShopSearchResultSortCriteria {
    ...
    REVIEW_COUNT("COUNT", Comparator.comparingLong(InnerOrderableShopSearchResult::reviewCount).reversed()),
    REVIEW_COUNT_ASC("COUNT_ASCD", Comparator.comparingLong(InnerOrderableShopSearchResult::reviewCount)),
    REVIEW_COUNT_DESC("COUNT_DESC", Comparator.comparingLong(InnerOrderableShopSearchResult::reviewCount).reversed()),
