...
public interface OrderableShopRepository extends Repository<OrderableShop, Integer> {

    Optional<OrderableShop> findById(Integer id);

    OrderableShop save(OrderableShop orderableShop);
