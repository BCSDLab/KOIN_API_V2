package in.koreatech.koin._common.socket.domain.message.repository;
...
import in.koreatech.koin._common.socket.domain.message.exception.MessageProcessingException;
import in.koreatech.koin._common.socket.domain.message.model.ChatMessageEntity;
import in.koreatech.koin._common.socket.domain.message.model.redis.ChatMessageRedisEntity;
