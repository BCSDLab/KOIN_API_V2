package in.koreatech.koin._common.domain.email.service;
...
import in.koreatech.koin._common.domain.email.form.MailFormData;
import in.koreatech.koin._common.domain.email.model.SesMailSender;
