...
@Component
public class AdminCommutingBusRouteInfoInitializer {
    ...
    public RouteInfos extract(Sheet sheet, Integer startRowIndex) {
        Row routeNameRow = sheet.getRow(startRowIndex);
        String northRouteName = getCellValueAsString(routeNameRow, NORTH_CELL_NUMBER);
        String southRouteName = getCellValueAsString(routeNameRow, SOUTH_CELL_NUMBER);
        return RouteInfos.from(RouteInfo.of(northRouteName), RouteInfo.of(southRouteName));
    }
