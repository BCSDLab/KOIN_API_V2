...
public record AdminMenuDetailResponse(
    ...
    public static AdminMenuDetailResponse createForSingleOption(Menu menu, List<MenuCategory> shopMenuCategories) {
    ...
    public static AdminMenuDetailResponse createMenuDetailResponse(Menu menu, List<MenuCategory> menuCategories) {
        if (menu.hasMultipleOption()) {
            return AdminMenuDetailResponse.createForMultipleOption(menu, menuCategories);
        }
        return AdminMenuDetailResponse.createForSingleOption(menu, menuCategories);
    }

    public static AdminMenuDetailResponse createForMultipleOption(Menu menu, List<MenuCategory> shopMenuCategories) {
        if (!menu.hasMultipleOption()) {
