CREATE TABLE IF NOT EXISTS `koin`.`orderable_shop_menu_images`
(
...
CREATE INDEX idx_images_on_menu_id ON `koin`.`orderable_shop_menu_images` (orderable_shop_menu_id);
