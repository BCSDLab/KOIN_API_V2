...
VALUES ('25-2학기', '2025-09-01', '2025-12-19', 1);
...
VALUES (1, '041-560-1278', '학생회관 2층', '천원의 아침밥 평일 운영', @SEMESTER_ID),
       (2, '041-560-1778', '복지관 2층', '복지관 리모델링 공사(2학기)', @SEMESTER_ID),
       (3, '041-560-1779', '복지관 1층', '배달 서비스 실시, 공·일요일 미운영', @SEMESTER_ID),
       (4, '041-560-1756', '복지관 1층', NULL, @SEMESTER_ID),
       (5, '041-552-1489', '학생회관 2층', '점심시간 12:00 - 13:00', @SEMESTER_ID),
       (6, '041-560-1093', '학생회관 2층', '점심시간 11:30 - 12:30', @SEMESTER_ID),
       (7, '041-560-1279', '복지관 1층, 참빛관 1층', '복지관·생활관', @SEMESTER_ID),
       (8, '041-560-1372', '학생회관 1층', '예약제운영', @SEMESTER_ID),
       (9, '041-560-1472', '학생회관 1층', NULL, @SEMESTER_ID),
       (10, '041-560-1758', '학생회관 1층', '점심시간 12:00 - 13:00', @SEMESTER_ID),
       (11, '041-560-1760', '학생회관 1층', '점심시간 14:00 - 15:00', @SEMESTER_ID);
