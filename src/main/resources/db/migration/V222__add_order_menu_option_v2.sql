...
(
    ...
    `orderable_shop_menu_group_id`      INT UNSIGNED    NOT NULL    COMMENT '주문 가능 상점 옵션 그룹 ID',
    `orderable_shop_menu_option_id`     INT UNSIGNED    NOT NULL    COMMENT '주문 가능 상점 옵션 ID',
