CREATE TABLE IF NOT EXISTS `koin`.`order_menu_option_v2`
(
    ...
    PRIMARY KEY (`id`),
    CONSTRAINT `fk_order_menu_option_menu_v2` FOREIGN KEY (`order_menu_id`) REFERENCES `koin`.`order_menu_v2` (`id`)
);
