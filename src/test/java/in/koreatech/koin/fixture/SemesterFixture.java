...
public class SemesterFixture {
    ...
    public Semester semesterV3_2019년도_1학기() {
    ...
    public Semester semesterV3_2019년도_2학기() {
        return semesterRepositoryV3.save(
            Semester.builder()
            .semester("20192")
            .year(2019)
    ...
    public Semester semesterV3_2019년도_여름() {
        return semesterRepositoryV3.save(
            Semester.builder()
            .semester("2019-여름")
            .year(2019)
    ...
    public Semester semesterV3_2019년도_겨울() {
        return semesterRepositoryV3.save(
            Semester.builder()
            .semester("2019-겨울")
            .year(2019)
    ...
    public Semester semesterV3_2020년도_1학기() {
        return semesterRepositoryV3.save(
            Semester.builder()
            .semester("20201")
            .year(2020)
    ...
    public Semester semesterV3_2020년도_2학기() {
        return semesterRepositoryV3.save(
            Semester.builder()
            .semester("20202")
            .year(2020)
    ...
    public Semester semesterV3_2020년도_여름() {
        return semesterRepositoryV3.save(
            Semester.builder()
            .semester("2020-여름")
            .year(2020)
    ...
    public Semester semesterV3_2020년도_겨울() {
        return semesterRepositoryV3.save(
            Semester.builder()
            .semester("2020-겨울")
            .year(2020)
